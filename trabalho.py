...
if pages[page] == 'vendedor':
    st.title('Análise de quem vendeu mais')
...
# Página de Forma de Cobrança
    ...
    st.title('Análise da forma de cobrança')
...
# Página de Forma de Captação
    ...
    st.title('Análise da forma que foi captada cada cliente')
